...
describe('favorite blog', () => {
    ...
    test('When list is empty, then undefined', () => {
        const result = listHelper.favoriteBlog([])
        expect(result).toBe(undefined)
    })
    test('When list has one element, then favorite is that element', () => {
        const result = listHelper.favoriteBlog(listOfOneBlog)
        expect(result).toBe(listOfOneBlog[0])
    })
...
describe('Author with most blogs', () => {
    ...
    test('When list has one element, then it is the author of that blog', () => {
